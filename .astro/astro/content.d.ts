...
"kelebihan-wa-marketing.mdx": {
	id: "kelebihan-wa-marketing.mdx";
  slug: "kelebihan-wa-marketing";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
"strategi-wa-marketing.mdx": {
	id: "strategi-wa-marketing.mdx";
  slug: "strategi-wa-marketing";
  body: string;
  collection: "docs";
  data: InferEntrySchema<"docs">
} & { render(): Render[".mdx"] };
